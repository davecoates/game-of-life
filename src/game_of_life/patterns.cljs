...
(def all-patterns [gosper-glider-gun bi-gun acorn five-engine-cordership
                   queen-bee-loop ten-engine-cordership wing-spaceship
                   gliders-by-the-dozen bomber-predecessor replicator c3ladders
                   life-without-death-quadratic maze-wickstretcher moon])
